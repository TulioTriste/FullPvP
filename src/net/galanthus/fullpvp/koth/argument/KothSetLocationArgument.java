...
public class KothSetLocationArgument extends CommandArgument implements CommandExecutor {
    ...
    public KothSetLocationArgument(final FullPvP plugin) {
        super("setlocation", "Defines a new event", new String[] { "set" });
        this.plugin = plugin;
