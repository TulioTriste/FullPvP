...
public class Messager {
	...
	public static void console(String msg){
		Bukkit.getConsoleSender().sendMessage(ColorText.translate(msg));
		return;
	}
	
	public static void broadcast(String msg){
		Bukkit.broadcastMessage(ColorText.translate(msg));
		return;
	}
	...
	public static void commandSender(CommandSender sender, String string) {
		sender.sendMessage(ColorText.translate(string));
		return;
	}
