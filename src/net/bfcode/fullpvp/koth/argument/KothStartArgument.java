...
public class KothStartArgument extends CommandArgument implements CommandExecutor {
    ...
    public KothStartArgument(final FullPvP plugin) {
        super("start", "Defines a new event", new String[] { "start" });
        this.plugin = plugin;
