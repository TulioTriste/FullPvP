...
public class ScoreboardAPI
{
    ...
    public ScoreboardAPI(final Scoreboard scoreBoard, final String title) {
    ...
    public void remove(final int index) {
        ...
        final Team team = this.getOrCreateTeam(String.valueOf(ChatColor.stripColor(StringUtils.left(this.tag, 14))) + index, index);
        team.unregister();
    }
